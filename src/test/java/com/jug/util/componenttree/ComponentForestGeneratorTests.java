...
//        }
        ...
        Plotting.showComponentForest(componentTree, new ArrayList<>(), raiFkt);
    }
...
//            ImageJFunctions.show(Plotting.createImageWithComponent(component2));
//        }
        Plotting.showComponentForest(tree, new ArrayList<>(), tree.getSourceImage());
    }
    ...
    public void testWatershedding() throws IOException {
        ...
        Plotting.showComponentForest(tree, new ArrayList<>(), tree.roots().iterator().next().getSourceImage());
    }
