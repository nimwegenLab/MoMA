...
public class FeatureFlags {
    ...
    public static final ComponentCostCalculationMethod featureFlagComponentCost = ComponentCostCalculationMethod.UsingLogLikelihoodCost2; /* this controls how the component cost will be calculated */
}
