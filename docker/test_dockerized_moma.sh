...
./moma -p "${base_path}/mm.properties" -analysis slurm_test_3 -rl "${base_path}"
# /moma/moma_in_container.sh -p /home/micha/Documents/01_work/15_moma_notes/02_moma_development/feature/20230612-containerize-moma/mm.properties -analysis slurm_test_3 -rl /home/micha/Documents/01_work/15_moma_notes/02_moma_development/feature/20230612-containerize-moma/
