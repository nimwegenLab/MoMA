...
public class ComponentPropertiesTest {
    ...
    public void testGettingComponentProperties() throws IOException {
        ...
        ComponentProperties props = new ComponentProperties(ij.op(), new Imglib2Utils(ij.op()), mock(ICostFactory.class), mock(IConfiguration.class));
        ...
        Plotting.showComponentForest(tree, new ArrayList<>(), roots.get(0).getSourceImage());
...
//        Plotting.showComponentForest(tree, new ArrayList<>());
        OpService ops = ij.op();
