...
public class Bugfix__20221101_debug_issue_with_component_tree_generation_in_lis_data {
    ...
    public Bugfix__20221101_debug_issue_with_component_tree_generation_in_lis_data() {
        datasetSubfolder = "bugfix/20221101-debug-issue-with-component-tree-generation-in-lis-data"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
    ...
    public static void main(String[] args) {
        Bugfix__20221101_debug_issue_with_component_tree_generation_in_lis_data tests = new Bugfix__20221101_debug_issue_with_component_tree_generation_in_lis_data();
