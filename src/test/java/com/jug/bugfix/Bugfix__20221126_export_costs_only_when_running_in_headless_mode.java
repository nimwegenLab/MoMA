...
public class Bugfix__20221126_export_costs_only_when_running_in_headless_mode {
    ...
    public Bugfix__20221126_export_costs_only_when_running_in_headless_mode() {
        datasetSubfolder = "bugfix/20221126-export-costs-only-when-running-in-headless-mode"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
