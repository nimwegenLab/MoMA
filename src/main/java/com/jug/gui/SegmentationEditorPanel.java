...
public class SegmentationEditorPanel extends IlpVariableEditorPanel {
    ...
    private void addCheckboxForSettingIlpConstraints(MoMAGui mmgui) {
        ...
        checkboxIsSelectedForSettingIlpConstraints.addActionListener((x) -> LoggingHelper.logUiAction(checkboxIsSelectedForSettingIlpConstraints, "SegmentationEditorPanel.checkboxIsSelectedForSettingIlpConstraints for timeStep=" + timeStepToDisplay()));
    ...
    private void addCheckboxForSelectingGtExport(MoMAGui mmgui) {
        ...
        checkboxIsSelectedAsGroundTruth.addActionListener((x) -> LoggingHelper.logUiAction(checkboxIsSelectedAsGroundTruth, "SegmentationEditorPanel.checkboxIsSelectedAsGroundTruth for timeStep=" + timeStepToDisplay()));
