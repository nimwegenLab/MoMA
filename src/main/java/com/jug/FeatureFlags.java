...
public class FeatureFlags {
    ...
    public static final boolean featureFlagUseComponentCostWithProbabilityMap = true; /* this enables the new method for calculating component-costs using the probability maps */
}
