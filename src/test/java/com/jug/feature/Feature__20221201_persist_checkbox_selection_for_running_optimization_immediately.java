...
public class Feature__20221201_persist_checkbox_selection_for_running_optimization_immediately {
    ...
    public Feature__20221201_persist_checkbox_selection_for_running_optimization_immediately() {
        datasetSubfolder = "feature/20221201-persist-checkbox-selection-for-running-optimization-immediately"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
    ...
    public static void main(String[] args) {
        Feature__20221201_persist_checkbox_selection_for_running_optimization_immediately tests = new Feature__20221201_persist_checkbox_selection_for_running_optimization_immediately();
