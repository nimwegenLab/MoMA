...
//        byte val = 127;
//        ValuePair<AdvancedComponent<FloatType>, RandomAccessibleInterval<ByteType>> componentAndImage = testUtils.getComponentWithImage(imageFile,
//                componentIndex,
//                new ByteType(val));
//        RandomAccessibleInterval<ByteType> image = componentAndImage.getB();
