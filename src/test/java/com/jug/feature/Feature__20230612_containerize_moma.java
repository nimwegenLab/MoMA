...
public class Feature__20230612_containerize_moma {
    ...
    public Feature__20230612_containerize_moma() {
        datasetSubfolder = "feature/20230612-containerize-moma"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
