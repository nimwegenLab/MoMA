...
public class FeatureFlags {
    ...
    public static final boolean filterAssignmentsByComponentSizeMatch = false; /* this feature compares the size of components being mapped; a too strong mismatch will be considered implausible */
}
