...
#export DISPLAY=""
#./moma.py --props "${base_path}/mm.properties" -f -tmax 10 -analysis slurm_test_3 -headless -trackonly --infolder "${base_path}/20211026_VNG1040_AB6min_2h_1_MMStack_Pos7_GL12.tif"

# command for testing the "CURATE" stage of the batch-run workflow:
#./moma.py -p "${base_path}/mm.properties" -f -tmax 10 -analysis slurm_test_3 -rl "${base_path}"
