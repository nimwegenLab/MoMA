...
public class FeatureFlags {
    ...
    public static final boolean featureFlagFilterAssignmentsByComponentSizeMatch = false; /* this feature compares the size of components being mapped; a too strong mismatch will be considered implausible */
}
