...
public class Bugfix__20230106_fix_exporting_and_loading_of_pruning_state__backport_to_v0.6.0 {
    ...
    public Bugfix__20230106_fix_exporting_and_loading_of_pruning_state__backport_to_v0.6.0() {
        datasetSubfolder = "bugfix/20230106-fix-exporting-and-loading-of-pruning-state--backport_to_v0.6.0"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
    ...
    public static void main(String[] args) {
        Bugfix__20230106_fix_exporting_and_loading_of_pruning_state__backport_to_v0.6.0 tests = new Bugfix__20230106_fix_exporting_and_loading_of_pruning_state__backport_to_v0.6.0();
