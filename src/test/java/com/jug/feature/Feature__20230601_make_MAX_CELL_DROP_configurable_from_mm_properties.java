...
public class Feature__20230601_make_MAX_CELL_DROP_configurable_from_mm_properties {
    ...
    public Feature__20230601_make_MAX_CELL_DROP_configurable_from_mm_properties() {
        datasetSubfolder = "feature/20230601-make-MAX_CELL_DROP-configurable-from-mm-properties"; /* DO NOT CHANGE: value is overwritten by the script start_topic_branch.sh, which uses this template to create a session for e.g. feature-development or bug-fixing */
