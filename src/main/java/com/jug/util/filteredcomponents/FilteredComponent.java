 ...
 * set
 * of pixels can be accessed by iterating ({@link #iterator()}) the component.nn
 *
 ...
 */
public final class FilteredComponent< T extends Type< T > >
		implements
		Component< T, FilteredComponent< T > >,
		TreeNode< FilteredComponent< T > >
{
	/**
